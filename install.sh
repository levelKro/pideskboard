...
echo ">> Also, you must configure the auto-login via the raspi-ci=onfig program"
	...
	sudo apt install -y gir1.2-gst-plugins-base-1.0 gstreamer1.0-plugins-good gstreamer1.0-plugins-ugly gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly-amr 
	echo "... done" -n 1
